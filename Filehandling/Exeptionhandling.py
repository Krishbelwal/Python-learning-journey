# holt
# Exception in python-  
# Name - it returns when we acess a wrong name , index - it returns when we acess a wrong index which doesn't exist in any itreable objects . atribute , type - when an operation performed with an invalid types . value - when an object recives  an arguements correctly but with an inappropialtly values 
# Atribute error Ex- 
# l = [1 , 3 , 4 , 5 ]
# l.age()
...
# def check_age(age):
#     if(age<=0):
#         raise ValueError("Age cannot be negative. please check the age")
#     else:
